'''
Descripttion: seg与det合并提交;
version: 1.0
Author: SongJ
Date: 2021-07-19 16:47:15
LastEditors: SongJ
LastEditTime: 2021-09-01 09:11:21
'''
...
def hough(img):
    ...
    # hough
    lines = cv2.HoughLinesP(img, 1.85, np.pi/180, 66, minLineLength=1,maxLineGap=150)
...
def predict(opt):
    ...
    # seg inference
        ...
        #seg_result = seg_result[:,:] * 100 # 加大区分度
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='model/best66.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--argmax', type=bool,default=False, help='') # export 的模型必须是False
